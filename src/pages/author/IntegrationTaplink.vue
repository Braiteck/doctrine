        ...
        <section class="integration_info block">
            ...
            <section class="head_data">
                ...
                <div class="info">
                    ...
                    <div class="title">{{ $t('message.integration2_title') }}</div>

                    <!-- Интеграция - Верхняя информация - Описание -->
                    <div class="desc">{{ $t('message.integration2_desc') }}</div>
            ...
            <section class="actions">
                ...
                <div class="items">
                    ...
                    <div class="action">
                        ...
                        <div class="name">
                            <div v-html="$t('message.integration2_action1_name')"></div>
                        </div>
                        ...
                        <form @submit.prevent="onSubmit" class="pages form" :class="{ processing: processing }">
                            ...
                            <div class="line" v-for="(link, index) in integration.links" :key="`${index}`">
                                <div class="field">
                                    ...
                                    <button type="button" class="delete_btn" @click.prevent="deleteLink(index)">
                            ...
                            <button class="add_btn" @click.prevent="addLink">
...
export default {
    ...
    beforeCreate () {
        // Загрузка интеграций
        this.$store.dispatch('authorIntegrations/loadIntegrationTaplink', 0).then(() => {
            // Запись данных
            this.integration = this.$store.state.authorIntegrations.taplink
    ...
    methods: {
        ...
        deleteLink (linkIndex) {
            this.integration.links.splice(linkIndex, 1)
        },
    ...
    watch: {
        ...
        'sendRequest': function () {
            if(this.sendRequest){
                ...
                this.$store.dispatch('authorIntegrations/loadIntegrationTaplink', ((this.currentPage-1)*this.$store.state.authorIntegrations.limit)).then(() => {
                    // Запись данных
                    this.integration = this.$store.state.authorIntegrations.taplink
